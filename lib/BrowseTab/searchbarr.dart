    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          border: OutlineInputBorder(borderRadius: BorderRadius.circular(25),borderSide: BorderSide(color: MyTheme.bordersColor)),
          prefixIcon: Icon(Icons.search,color: MyTheme.bordersColor,),
        ),
      ),
    );
  }
