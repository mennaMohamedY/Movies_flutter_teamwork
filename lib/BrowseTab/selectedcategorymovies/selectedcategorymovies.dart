...
class SelectedCategoryMoviesScreen extends StatefulWidget {
  ...
  @override
  State<SelectedCategoryMoviesScreen> createState() =>
      _SelectedCategoryMoviesScreenState();
}

class _SelectedCategoryMoviesScreenState
    extends State<SelectedCategoryMoviesScreen> {
  ...
  Widget build(BuildContext context) {
    categoryGenere = ModalRoute.of(context)?.settings.arguments as Genres;
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.data?.success == false) {
                        return Column(
                          children: [
                            Text(
                              "Error message: ${snapshot.data?.status_message} \n with error Code ${snapshot.data?.status_code}",
                              style: TextStyle(
                                color: Colors.white,
                              ),
                            ),
